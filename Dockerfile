...
# Chromium is required by Marp CLI to generate PPTX/PDF
...
# Install Marp CLI and Express globally
...
app.post('/convert', (req, res) => {
  ...
  try {
    ...
    execSync(
      ...
      { stdio: 'pipe', env: { ...process.env, CHROME_PATH: '/usr/bin/chromium-browser' } }
    );
